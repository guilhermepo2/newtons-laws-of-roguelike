...
if grid_place_meeting(x+lengthdir_x(speed_, direction_), y+lengthdir_y(speed_, direction_)) and !_bounce {
...
if grid_place_meeting(x+_x_speed, y) {
while !grid_place_meeting(x+sign(_x_speed), y) {
x += sign(_x_speed);
}
...
if grid_place_meeting(x, y+_y_speed) {
while !grid_place_meeting(x, y+sign(_y_speed)) {
y += sign(_y_speed);
}
